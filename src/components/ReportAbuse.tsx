      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <Button 
            ...
            className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 text-xl animate-pulse"
          >
            🚨 URGENT SOS - Call Now
          </Button>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {helplines.map((helpline) => (
              <Card key={helpline.id} className="border-l-4 border-l-red-500 hover:shadow-lg transition-shadow">
                <CardContent className="p-4">
                  ...
                  <div className="flex space-x-1">
                    <Button 
                      size="sm" 
                      className="flex-1 bg-red-500 hover:bg-red-600 text-xs py-1"
            ...
            {reports.map((report) => (
              <Card key={report.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="relative h-48">
                  ...
                  <div className={`absolute top-4 right-4 px-2 py-1 rounded text-xs font-medium ${getUrgencyColor(report.urgency)}`}>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="flex-1 p-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-center"
                      title="View Location"
                    >
                      <Navigation className="h-4 w-4 text-gray-600 mx-auto" />
                    </button>
                    <button
                      ...
                      title="Share Report"
                    >
                      <Share2 className="h-4 w-4 text-gray-600 mx-auto" />
                    </button>
                  </div>
                </CardContent>
              </Card>
